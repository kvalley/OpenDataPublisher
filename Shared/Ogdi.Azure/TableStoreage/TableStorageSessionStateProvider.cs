...
namespace Microsoft.Samples.ServiceHosting.AspProviders
{
    ...
    internal class SessionDataServiceContext : DataServiceContext//TableServiceContext
    {
        public SessionDataServiceContext() : base(new Uri("")) { }
    ...
    [CLSCompliant(false)]
    public class SessionRow : sqlTableServiceEntity
    {
        private string _id;
    ...
    public class TableStorageSessionStateProvider : SessionStateStoreProviderBase
    {
        ...
        private sqlTableClient _tableStorage;
        ...
        private sqlTableServiceContext CreateDataServiceContext()
        {
            return _tableStorage.GetDataServiceContext();
        }

        private static void ReleaseItemExclusive(sqlTableServiceContext svc, SessionRow session, object lockId)
        {
        ...
        private SessionRow GetSession(string id, DataServiceContext context)
        {
            ...
            try
            {
                ...
                IEnumerable<SessionRow> sessions = null;// = query.Execute();
