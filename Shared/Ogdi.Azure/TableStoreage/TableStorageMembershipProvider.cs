...
namespace Microsoft.Samples.ServiceHosting.AspProviders
{
    ...
    internal class MembershipDataServiceContext// : sdkTableServiceContext
    {
        public MembershipDataServiceContext()// : base(null, null)
        { }
    }

    [CLSCompliant(false)]
    public class MembershipRow : sqlTableServiceEntity, IComparable
    {
    ...
    public class TableStorageMembershipProvider : MembershipProvider
    {
        ...
        private MembershipUser ProcessGetUserQuery(sqlTableServiceContext svc, IQueryable<MembershipRow> query, bool updateLastActivityDate)
        {
            return null;
            //if (query == null)
            //{
