...
<div class="dataset-data">
    <div class="content">
        ...
        <div id="LoadingIndicatorPanel" style="display: none; position: ">
            <img id="imgLoading" class="loader" alt='<%= UIConstants.GC_LoadingAltText %>' style="display: none"
                src='<%=UIConstants.GC_LoadingImagePath %>' longdesc='<%= UIConstants.GC_LoadingLongDesc %>'
        ...
        <div id="tabs" style="visibility: hidden;">
            ...
            <div id="tabs-2">
                <div id="divMapViewResults" style="display: none;">
                    ...
                    <% }
                       ...
                       { %>
                    <div id="map_box" style="width: 862px; height: 450px;">
            ...
            <div id="tabs-3" style="display: none;">
                <div id="divOuterBarChartResults" style="height: 630px;" style="display: none;">
                    <div>
                        <table style="width: 100%;">
                            <tr style="height: 100%;">
                                <td>
                                    <fieldset style="height: 130px; padding: 0px; border-style: solid; border-color: #eeeeee;">
                                        <legend style="text-align: left;"><b>Horizontal Axis</b> </legend>
                                        <br />
                                        <table>
                                            ...
                                            <tr style="padding: 10px">
                                                <td style="text-align: left;">
                                                    <label id="labelBarDateRange" style="display: none;">
                                                        Date
                                                        <br />
                                                        Range:</label>
                                                </td>
                                ...
                                <td>
                                    <fieldset style="height: 130px; text-align: center; padding: 0px; border-style: solid;
                                        border-color: #eeeeee;">
                                        <legend style="text-align: left;"><b>Vertical Axis</b> </legend>
                                        <table>
                                            <tr>
                                                <td style="width: 150px;">
                                                    <fieldset style="height: 100px; width: 150px; padding: 0px; border-style: solid;
                                                        border-color: #eeeeee;">
                                                ...
                                                <td>
                                                    <fieldset style="height: 100px; padding: 0px; border-style: solid; border-color: #eeeeee;">
                                                        <legend style="text-align: left;">
                                                        ...
                                                        <div>
                                                            <table>
                                                                <tr style="padding: 10px;">
                                                                    <td style="text-align: left;">
                                                                        <label id="VerticalComboBoxLabel" style="color: Gray;">
                                                                            Entityset
                                                                            <br />
                                                                            Column:&nbsp;&nbsp;</label>
                                                                    </td>
                    ...
                    <div id="divBarChartError" style="display: none; background-color: Red; color: White;
            ...
            <div id="tabs-4" style="display: none;">
                <div id="divPieResultHeight">
                                                    ...
                                                    <fieldset style="height: 100px; padding: 0px; border-style: solid; border-color: #eeeeee;">
                                                        ...
                                                        <div>
                                                            <table>
                                                                <tr style="padding: 10px;">
                                                                    <td style="text-align: left;">
                                                                        <label id="labelPieVerticalComboBox" style="color: Gray">
                                                                            Entityset
                                                                            <br />
                                                                            Column:&nbsp;&nbsp;</label>
                                                                    </td>
                    ...
                    <div id="divPieChartError" style="display: none; background-color: Red; color: White;
                        text-align: center; font-weight: bold; font-size: 17px;">
                        <%= UIConstants.DBPC_ChartErrorText %>
                    </div>
        ...
        <div id="filterDialog" title="$filter hints" class="filterdialog" style="display: none;">
            <p>
                OGDI uses a subset of the <a href="http://msdn.microsoft.com/en-us/library/cc668784(VS.100).aspx">
                    WCF Data Services query syntax</a><img src='<%= UIConstants.GC_ExternalLinkImagePath %>'
                        alt='<%= UIConstants.DBPC_ADOqueryAltText %>' title='<%= UIConstants.DBPC_ADOqueryTitle %>'
                    ...
                    <td style="vertical-align: top">
                        <p>
                            ...
                            UTC. Date/time literals are expressed in <a href="http://en.wikipedia.org/wiki/ISO_8601"
                                target="_blank">ISO 8601</a><img src="<%= UIConstants.GC_ExternalLinkImagePath %>"
                                    alt="<%= UIConstants.DBPC_ISO8601AltText %>" title="<%= UIConstants.DBPC_ISO8601Title %>"
