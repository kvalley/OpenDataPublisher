        ...
        <div id="sampleCodeTabs" style="visibility: hidden;">
            ...
            <div id="code-tabs-1">
                <div id="divOuterDataViewSampleCode">
                    ...
                    &nbsp;&nbsp;<img id="copyDataCodeButton" src='<%= UIConstants.DBPC_CopyDataImagePath %>'
                        class="copyicon" title="Copy to Clipboard" alt='<%= UIConstants.DBPC_CopyDataAltText %>'
                        longdesc="<%= UIConstants.DBPC_CopyDataLongDesc %>" />
                    <br />
                    <div id="divDataViewSampleCode" class="codesamplescroll">
                        <div>
                            <% Html.RenderPartial("SampleCodeDataView", ViewData); %></div>
                    </div>
                </div>
            </div>
            <div id="code-tabs-2">
                <div id="divOuterMapViewSampleCode">
                    <p>
                        ...
                        execution. You can download jquery-1.4.2.min.js from <a href="http://ajax.microsoft.com/ajax/jquery/jquery-1.4.2.min.js">
                            here</a>.</p>
                    <div style="vertical-align: bottom; margin-top: 5px; float: left;">
                        Language/Environment:&nbsp;
                    ...
                    &nbsp;<img id="copyMapCodeButton" src='<%= UIConstants.DBPC_CopyDataImagePath %>'
                        class="copyicon" title="Copy to Clipboard" alt='<%= UIConstants.DBPC_CopyDataAltText %>'
                        longdesc='<%= UIConstants.DBPC_CopyDataLongDesc %>' />
                    <br />
            ...
            <div id="code-tabs-3">
                <div id="divOuterBarChartViewSampleCode">
                    ...
                    &nbsp;<img id="copyBarChartCodeButton" src='<%= UIConstants.DBPC_CopyDataImagePath %>'
                        class="copyicon" title="Copy to Clipboard" alt='<%= UIConstants.DBPC_CopyDataAltText %>'
                        longdesc='<%= UIConstants.DBPC_CopyDataLongDesc %>' />
                    <br />
            ...
            <div id="code-tabs-4">
                <div id="divOuterPieChartViewSampleCode">
                    ...
                    &nbsp;<img id="copyPieChartCodeButton" src='<%= UIConstants.DBPC_CopyDataImagePath %>'
                        class="copyicon" title="Copy to Clipboard" alt='<%= UIConstants.DBPC_CopyDataAltText %>'
                        longdesc='<%= UIConstants.DBPC_CopyDataLongDesc %>' />
                    <br />
