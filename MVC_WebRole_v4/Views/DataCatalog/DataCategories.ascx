...
<%@ Control Language="C#" Inherits="OgdiViewUserControl<Odp.InteractiveSdk.Mvc.Models.DataCatalogModel>" %>
...
<td valign="top" id="rightPanelDiv"><% Html.RenderPartial("EntitySets", Model); %></td>
