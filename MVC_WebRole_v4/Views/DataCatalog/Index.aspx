<%@ Page Language="C#" MasterPageFile="~/Views/Shared/ODP_MasterOriginal.Master" Inherits="System.Web.Mvc.ViewPage<Odp.InteractiveSdk.Mvc.Models.DataCatalogModel>" %>
...
<asp:Content ID="dataCatalogContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="form1">
        <div>
            ...
            <h1>Data Catalog</h1>
            <div>
                <div id="Para1" style="cursor: hand" title="Click for more details..." class="collapsePanelHeader">
                    <p class="big">
                ...
                <p class="big" style="margin: 0px; padding-top: 0px;">
                    Select Container: <%= Html.DropDownList("Containers", ViewData.Model.ContainerList)%>
                </p>
                <div class="legallink">
