<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ODP_MasterOriginal.Master" Inherits="System.Web.Mvc.ViewPage<Odp.InteractiveSdk.Mvc.Models.ContributorModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="dataset">
            <div class="name">Add/Edit Contributors</div>
            ...
            <div class="dataset-data">
                <div class="content">
                    <div id="inputArea">
                        ...
                        <label for="name">Description</label><%= Html.TextArea("description", model.Description) %>
                        <label for="name">Disclaimer</label><%= Html.TextArea("disclaimer", model.Disclaimer) %>
