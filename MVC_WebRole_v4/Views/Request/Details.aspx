...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/OGDIMasterPage.Master" Inherits="OgdiViewPage<Odp.InteractiveSdk.Mvc.Models.Request.Request>" %>
<%@ Import Namespace="Odp.InteractiveSdk.Mvc.Models" %>
<%@ Import Namespace="Odp.InteractiveSdk.Mvc.Models.Request" %>
<%@ Import Namespace="Odp.InteractiveSdk.Mvc.Models.ViewData" %>
	...
	<div class="request-details dataset">
		...
		<div class="parameters">
			...
			<div class="left">
				...
				<div><%= Html.Encode(String.Format("{0:" + Odp.InteractiveSdk.Mvc.Globals.ShortDateFormat + "}", Model.PostedDate)) %></div>
			</div>
			<div class="left">
