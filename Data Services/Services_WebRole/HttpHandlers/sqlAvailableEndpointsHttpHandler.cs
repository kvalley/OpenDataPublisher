...
namespace Odp.DataServices
{
    ...
    public class sqlAvailableEndpointsHttpHandler : sqlTableStorageHttpHandlerBase, IHttpHandler
    {

        private const string START_SERVICEDOCUMENT_TEMPLATE =
@"<?xml version='1.0' encoding='utf-8' standalone='yes'?>
<feed xml:base='http://{0}/v1/AvailableEndpoints/' xmlns:d='http://schemas.microsoft.com/ado/2007/08/dataservices' xmlns:m='http://schemas.microsoft.com/ado/2007/08/dataservices/metadata' xmlns='http://www.w3.org/2005/Atom'>
  <title type='text'>AvailableEndpoints</title>
  <id>http://{0}/v1/AvailableEndpoints/</id>
  <updated></updated>
...
@"
	<entry m:etag=''>
		<id>http://{0}/v1/AvailableEndpoints(PartitionKey=""{1}"",RowKey="""")</id>
		<title type='text'></title>
		<updated></updated>
		<author>
			<name />
		</author>
		<link rel='edit' title='AvailableEndpoints' href='AvailableEndpoints(PartitionKey=""{1}"",RowKey="""")' />
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string wholeXml = string.Format(START_SERVICEDOCUMENT_TEMPLATE, _context.Request.Url.Host);
                    ...
                    //foreach (var item in list)
                    {
                        ...
                        wholeXml += string.Format(ENTRY_TEMPLATE, _context.Request.Url.Host, "sql", "Endpoint for SQL server connection.", "Here comes the disclaimer...");
                    }
