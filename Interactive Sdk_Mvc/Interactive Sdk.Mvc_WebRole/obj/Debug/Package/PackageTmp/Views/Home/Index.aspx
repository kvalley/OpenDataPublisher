    <%@ Page Language="C#" MasterPageFile="~/Views/Shared/ODP_MasterOriginal.Master" Inherits="System.Web.Mvc.ViewPage<Odp.InteractiveSdk.Mvc.Models.HomeModel>" %>
<%@ Import Namespace="Odp.InteractiveSdk.Mvc.App_GlobalResources"  %>
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContent" runat="server">
    
    <div class="welcome">
		
		<%= System.Configuration.ConfigurationManager.AppSettings["HomePageHeading"]%>
        <%= System.Configuration.ConfigurationManager.AppSettings["HomePageContent"]%>        
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td>
                    ...
                    <p class="smalldescription">
                        Read brief developer notes and learn how to use the Open Data Publisher API.
                    </p>
                </td>
            </tr>
            <%if(false){ %>
                                ...
                                <div class="welcomevideo">
                                    <object data="data:application/x-silverlight-2," type="application/x-silverlight-2"
                                        ...
                                        <object classid="<%= UIConstants.HPC_ClassId %>" codebase="<%= UIConstants.HPC_CodeBase %>"
                                            ...
                                            <param name="movie" value="<%= System.Configuration.ConfigurationManager.AppSettings["WelcomeVideoURL"]%>" />

                                            <param name="quality" value="high" />
                                            <param name="bgcolor" value="#ffffff" />
                                            <param name="wmode" value="opaque" />
                                            <embed src="<%= System.Configuration.ConfigurationManager.AppSettings["WelcomeVideoURL"]%>" quality="high"
