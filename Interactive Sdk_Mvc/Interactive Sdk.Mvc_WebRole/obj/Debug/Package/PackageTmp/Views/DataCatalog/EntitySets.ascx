<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Odp.InteractiveSdk.Mvc.Models.DataCatalogModel>" %>
...
<div class="sets">
	...
	{
		var odd = true;
		foreach (Odp.InteractiveSdk.Mvc.Models.EntitySet item in ViewData.Model.EntitySet)
		{ %>
	<tr class="<%= odd ? "co" : "ce" %>">
		<td>
