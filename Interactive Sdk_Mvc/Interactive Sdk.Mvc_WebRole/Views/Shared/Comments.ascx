...
<%@ Control Language="C#" Inherits="OgdiViewUserControl<Odp.InteractiveSdk.Mvc.Models.Comments.CommentInfo>" %>
<%@ Import Namespace="System.Web.Mvc" %>

<% String link = System.Configuration.ConfigurationManager.AppSettings["serviceUri"] + "Comments" + "/";
...
<script type="text/javascript">
	...
	function showCaptcha() {
	    Recaptcha.create('<%=System.Configuration.ConfigurationManager.AppSettings["RecaptchaPupblicKey"]%>', 'eidCommentsRecaptcha', RecaptchaOptions);
	}
