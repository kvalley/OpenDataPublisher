...
<%@ Control Language="C#" Inherits="OgdiViewUserControl<Odp.InteractiveSdk.Mvc.Models.DatasetListModel>" %>
...
<div class="dataset-filter form">
    ...
    <div class="content">
        <div style="padding: 10px; float: left;"><input type="text" id="KeywordsFilterSimple" style="width: 300px; padding: 10px; " /></div>
