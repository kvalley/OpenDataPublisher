...
<div class="query">
	...
	<div>
		...
		<label id="labelKmlQuery" title="<%= ViewData.Model.KmlQueryName %>" visible="false"></label>
	</div>
...
<% } %>
    ...
    var builder = new Odp.QueryBuilder($("#eidBuilder"), meta, $("#queryBox"), $("#eidQueryBoxContainer"));
	$(function() {
