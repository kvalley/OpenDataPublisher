...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ODP_MasterOriginal.Master" Inherits="OgdiViewPage<Odp.InteractiveSdk.Mvc.Models.Comments.AgencyCommentViewModel>" %>
			...
			<div class="parameters">
				...
				<div class="left" style="width:300px;">
					...
					<div class="below">
						...
						<div class="value"><%=item.Posted.ToString(Odp.InteractiveSdk.Mvc.Globals.ShortDateFormat)%></div>
						<div class="clear"></div>
					</div>
				</div>
				<div class="left">
