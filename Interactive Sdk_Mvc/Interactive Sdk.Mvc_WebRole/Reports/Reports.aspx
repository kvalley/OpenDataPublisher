<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" MasterPageFile="~/Reports/Reports.Master" Inherits="Odp.InteractiveSdk.Reports.Reports" %>
...
<div class="block reports">
	<div class="form">
		...
		<div class="content">
			<div class="left">
				...
				<div><asp:DropDownList ID="DropDownList1" runat="server" /></div>
			</div>			
			<div class="left">
				<div class="label">From</div>
				<div><asp:Calendar ID="From" runat="server" /></div>
			</div>
			<div class="left">
				<div class="label">To</div>
				<div><asp:Calendar ID="To" runat="server" /></div>
				<div class="buttons"><input type="submit" name="Run" value="Run"></div>
			</div>
			<div class="clear"></div>
		</div>
	</div>
	<div class="block">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                Font-Size="8pt" Width="800px" Height="600px" ProcessingMode="Local">
        <LocalReport>
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" >
            <SelectParameters>
                <asp:ControlParameter ControlID="From" Name="datefrom" PropertyName="SelectedDate" Type="DateTime" />
