...
namespace Microsoft.Samples.ServiceHosting.AspProviders
{
    internal static class Configuration
    {
        ...
        internal static string GetInitExceptionDescription(Uri tableBaseUri, Uri blobBaseUri)
        {
					return "";
        ...
        internal static string GetInitExceptionDescription(Uri baseUri, string desc)
        {
            StringBuilder builder = new StringBuilder();
