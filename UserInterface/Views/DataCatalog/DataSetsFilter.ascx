...
<%@ Control Language="C#" Inherits="Odp.UserInterface.OgdiViewUserControl<Odp.UserInterface.Models.DatasetListModel>" %>
...
<script type="text/javascript">
    ...
    function submitFilterSimple() {
        var result = new Object();

        result.Keywords = $("#KeywordsFilterSimple").val();
        return result;
    }
    ...
    function clearFilterSimple() {
        $("#KeywordsFilterSimple").val("");
    }
</script>
<div class="dataset-filter form">
    ...
    <div class="content">
        <div style="padding: 10px; float: left;">
            <input type="text" id="KeywordsFilterSimple" style="width: 300px; padding: 10px;" /></div>
        <div class="buttons" style="float: left; padding: 5px;">
            <%= Html.NiceButton(this, "filter", 0, "SubmitFilterSimple") %>
            <%= Html.NiceButton(this, "clear", 0, "ClearFilterSimple") %>
        </div>
    </div>
</div>
<% if (System.Configuration.ConfigurationManager.AppSettings["DisplayDatasetFilter"] == "true")
   { %>
<div class="dataset-filter form">
    <div class="bar">
        Datasets
                ...
                <td width="33%" align="left" valign="top">
                    <div class="category-block">
                        ...
                        <div id="CategoryGroup" class="items">
                            ...
                            %>
                            <div class="item">
                                <input type="checkbox" name="<%=category%>" value="<%=category%>" id="<%= id %>" /><label for="<%= id %>"><%= Html.Encode(category)%>
                                </label>
                            </div>
                            <% } %>
                        </div>
                ...
                <td width="33%" align="left" valign="top">
                    ...
                    <div class="data-source-block">
                        ...
                        <div id="DataSourceGroup" class="items" style="overflow-y: scroll;">
                            ...
                            %>
                            <div class="item">
                                <input type="checkbox" name="<%=container.Alias%>" value="<%=container.Alias%>" id="<%= id %>" /><label for="<%= id %>"><%= Html.Encode(container.Description)%>
                                </label>
                            </div>
                            <% } %>
                        </div>
                ...
                <td width="33%" align="left" valign="top">
                    <div class="rest-block">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td class="value published">from
                                    <input id="DateFromFilter" maxlength="10" size="10" class="calendar" />
                                </td>
                                <td align="center"></td>
                                <td class="value published">to
                                    <input id="DateToFilter" maxlength="10" size="10" class="calendar" />
                                </td>
                            </tr>
                            <tr class="field">
                            ...
                            <tr id="StatusesGroup">
                                <td class="value">
                                    <input type="checkbox" class="checkbox" name="Published" id="stPublished" /><label for="stPublished">Published
                                    </label>
                                </td>
                                <td></td>
                                <td class="value">
